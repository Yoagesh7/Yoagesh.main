/**
 * PushAI v2 — AI Engine
 * AI proxy calls, personality modes, HITL parsing
 */

// IMPORTANT:
// For GitHub Pages/static hosting, set your deployed backend/proxy URL here.
// Example: 'https://your-vercel-app.vercel.app/api/chat'
const AI_PROXY_URL = window.PAI_PROXY_URL || '/api/chat';
...
async function sendToAI(userMessage, chatHistory = []) {
    ...
    try {
        ...
        return {
            tasks: [],
            memories: [],
            cleanReply: `⚠️ AI connection issue: ${err.message}. Endpoint: ${AI_PROXY_URL}`
        };
    }
}
